        ...
        <form id="formcargo" name="formcargo" method='POST' action="#" onSubmit='return false' >
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        <label for="lb_cat">Nombre del Cargo</label>
                        <input type="text" class="form-control validate[required]" name="txt_nombre" id="txt_nombre" placeholder="Nombre del Cargo" value="<?php if(@$obj != NULL){ print @$obj->nombre_cargo; }?>" >
                    </div>
            ...
            <div  align="center" class="box-footer">
                <div class="form-actions ">
                    <button type="submit" class="btn btn-success btn-grad no-margin-bottom btnguardarcargo">
