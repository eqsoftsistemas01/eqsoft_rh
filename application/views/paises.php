...
// Setear el título HTML de la página
  print "<script>document.title = 'ProdegelRRHH - Listado de Paises'</script>";
...
<script type='text/javascript' language='javascript'>
  ...
  $(document).ready(function () {
    ...
    $(document).on('click', '.pais_ver', function(){
      id = $(this).attr('id');
      $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url('Paises/tmp_pais');?>",
        data: {id: id},
        success: function(json) {
          $.fancybox.open({
            type: "ajax",
    ...
    $(document).on('click', '.pais_add', function(){
      $.fancybox.open({
        type: "ajax",
        width: 550,
        height: 550,
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-registered"></i> Lista de Paises
      </h1>
      <ol class="breadcrumb">
