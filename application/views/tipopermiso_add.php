...
<div id = "contenido_ret" class="col-md-6">
    <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title"></i> Datos de Tipo de Permiso</h3>
        </div>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        <label for="lb_cat">Tipo de Permiso</label>
                        <input type="text" class="form-control validate[required]" name="txt_tipopermiso" id="txt_tipopermiso" placeholder="Tipo de Permiso" value="<?php if(@$obj != NULL){ print @$obj->tipopermiso; }?>" >
                    </div>
